...
func commands() []Command {
	return []Command{
		...
		{Name: "auth", Group: groupSetup, Summary: "Manage provider credentials (auth login --provider {anthropic|openai} runs the vendor OAuth flow in a one-shot container).", Run: runAuth},
