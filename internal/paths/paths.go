...
func From(home string) Layout {
	...
	return Layout{
		...
		BuiltinAgents:    filepath.Join(data, "builtin-agents"),
		CustomAgents:     filepath.Join(data, "agents"),
		BuiltinWorkflows: filepath.Join(data, "builtin-workflows"),
		CustomWorkflows:  filepath.Join(data, "workflows"),
